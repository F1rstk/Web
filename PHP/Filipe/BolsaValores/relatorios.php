            ...
            <div class="row">
              <div class="col-4 d-flex justify-content-center">
                <a href="abertos.php" class="text-danger">
                  <img src="imagens/caixa2-removebg-preview.png" width="70" height="70">
                  <p>Abertos(<?php 
                      print($totalAbertos);
                  ?>)</p>
                </a>
              ...
              <div class="col-4 d-flex justify-content-center">
                <a href="andamento.php" style="color:darkorange">
                  <img src="imagens/caixa-removebg-preview.png" width="70" height="70">
                  <p>Andamento(<?php 
              ...
              <div class="col-4 d-flex justify-content-center">
                <a href="finalizado.php" style="color:teal">
                  <img src="imagens/caixa3-removebg-preview.png" width="70" height="70">
                  <p>Finalizados(<?php 
